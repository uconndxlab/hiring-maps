          ...
          <div class="row-fluid">
            ...
            <div id="button-container">
              <div id="icon-container-search" class="icon-container">
                ...
                <div id="uconn-search-tooltip" style="z-index: 99999 !important" />
              </div>

              <div id="icon-container-az" class="icon-container">
                <a
                  id="uconn-az"
                  class="btn btn-popup-control"
                  href="https://uconn.edu/az"
                  aria-haspopup="true"
                ...
                <div id="a-z-popup" class="popup-container">
                  ...
                  <hr>
                  <div class="link-wrapper az-link-wrapper">
                    <a href="https://uconn.edu/az"><span class="banner-search-text" />UConn A-Z</a>
                  </div>
                </div>
              </div>
            </div>
